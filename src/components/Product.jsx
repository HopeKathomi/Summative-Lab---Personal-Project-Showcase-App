    ...
    <div className='bg-amber-100 flex flex-row flex-wrap justify-center items-center gap-7 '>
      {coffees
        ...
        .map(coffee => (
          <div
            key={coffee.id}
            className='bg-amber-50 flex flex-col gap-2 rounded-2xl border-taupe-300 border py-4 px-3 w-80 h-110'
          >
            <div className='bg-orange-100 border-taupe-300 border flex flex-col justify-center items-center py-5 rounded-2xl'>
              <div className='flex flex-col items-center justify-center shadow-md w-40 h-45 bg-orange-200'>
